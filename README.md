...
- **Languages:** the app ships complete catalogs for English, German, French, Spanish, Italian, Brazilian Portuguese, Polish, Russian, Japanese, and Simplified Chinese. Technical SAML values remain untranslated.
- **Development dependencies:** review Composer dependencies before release; no Composer audit command is currently configured in CI. A reviewed `composer.lock` should be committed when generated in a Composer-capable environment.
