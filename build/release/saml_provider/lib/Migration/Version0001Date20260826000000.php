...
class Version0001Date20260826000000 extends SimpleMigrationStep {
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
        ...
        $table->addColumn('sp_entity_id', 'string', ['notnull' => true, 'length' => 512]);
        $table->addColumn('sp_name', 'string', ['notnull' => true, 'length' => 255]);
        $table->addColumn('acs_url', 'string', ['notnull' => true, 'length' => 1024]);
        $table->addColumn('slo_url', 'string', ['notnull' => true, 'length' => 1024, 'default' => '']);
        $table->addColumn('sp_certificate', 'text', ['notnull' => true, 'default' => '']);
        ...
        $table->addColumn('attribute_mapping', 'text', ['notnull' => true, 'default' => '{}']);
        $table->addColumn('sign_assertions', 'boolean', ['notnull' => true, 'default' => true]);
