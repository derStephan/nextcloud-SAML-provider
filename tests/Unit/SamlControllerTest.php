...
final class SamlControllerTest extends TestCase {
 ...
 public function testIdpInitiatedReturnsNotFoundForUnknownService():void { $session=new Session(new User());$session->loggedIn=true;self::assertSame(404,$this->controller(new Request(),$session)->idpInitiated(9)->status); }
}
