...
final class SettingsControllerTest extends TestCase {
 ...
 public function testAcceptsEmptyObjectAttributeMappingButRejectsJsonArray():void { $ok=$this->controller->createSp('https://sp.mapping.test/meta','SP','https://sp.mapping.test/acs','urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress','{}'); self::assertSame(201,$ok->status); $bad=$this->controller->createSp('https://sp.mapping-array.test/meta','SP','https://sp.mapping-array.test/acs','urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress','[]'); self::assertSame(400,$bad->status); }
